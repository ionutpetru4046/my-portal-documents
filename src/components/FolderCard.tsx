  ...
  return (
    <Link href={`/dashboard/${slug}`}>
      <motion.div
        ...
        className={`flex flex-col items-center justify-center p-6 sm:p-8 md:p-10 rounded-3xl bg-white shadow-md cursor-pointer group w-full sm:w-44 md:w-52 lg:w-60 transition-all duration-300 transform ${
